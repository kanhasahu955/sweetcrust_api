"""SweetCrust Payments FastAPI app — package factory."""
...
def _startup() -> None:
    init_db()
    logger.info("payments_service ready")
...
def create_app() -> FastAPI:
    ...
    app = create_service_app(
        title="SweetCrust Payments",
        version=get_settings().service_version,
        description="Razorpay, COD, UPI",
        lifespan=lifespan,
    )
    app.include_router(routes.payments_router, prefix="/api/v1")
