...
overrides = {
    ...
    "AUTH_PUBLIC_BASE_URL": "https://api.skbakery.in",
    "DATABASE_URL": database_url,
    "CORS_ORIGINS": get("CORS_ORIGINS") if get("CORS_ORIGINS") not in ("", "*") else
        "https://skbakery.in,https://www.skbakery.in,https://admin.skbakery.in,https://store.skbakery.in,https://admin.bakerywala.cloud,https://store.bakerywala.cloud,https://bakerywala.cloud,https://www.bakerywala.cloud",
    "API_DOMAIN": get("API_DOMAIN") or "api.skbakery.in",
    "EXTRA_API_DOMAINS": get("EXTRA_API_DOMAINS") or "api.bakerywala.cloud",
